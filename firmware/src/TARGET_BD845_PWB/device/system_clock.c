...
/**
  ...
  *-----------------------------------------------------------------
  * System clock source | 1- USE_PLL_HSE_XTAL (external 16 MHz xtal)
  *                     | 2- USE_PLL_HSI (internal 8 MHz)
  *-----------------------------------------------------------------
  * SYSCLK(MHz)         | 48
  * AHBCLK (MHz)        | 48
  * APB1CLK (MHz)       | 48
...
#define USE_PLL_HSE_XTAL     0x4  // Use external xtal (Y301 on board)
...
//  HAL_RCC_MCOConfig(RCC_MCO, RCC_MCOSOURCE_HSE, RCC_MCO_DIV4); // 16/4 = 4 MHz
